...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.MpOpenID = field.NewString(tableName, "mp_open_id")
	...
	_user.IsDelete = field.NewUint(tableName, "is_delete")
...
func (u *user) updateTableName(table string) *user {
	...
	u.MpOpenID = field.NewString(table, "mp_open_id")
	...
	u.IsDelete = field.NewUint(table, "is_delete")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["mp_open_id"] = u.MpOpenID
